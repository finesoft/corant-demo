...
public class ProductServiceTest extends AbstractTest {
  ...
  public void update() {
    resolve(ProductService.class).update(mapOf("id", "535299352470487040", "number", "827001.0004",
        ...
        listOf(mapOf("name", "height", "type", AttributeType.NUMBERIC, "value", "65"),
            mapOf("name", "diameter ", "type", AttributeType.NUMBERIC, "value", "288"),
            mapOf("name", "Bolt hole number", "type", AttributeType.NUMBERIC, "value", "6"))));
  }
